...
- bdu --max-depth=1 --warn-at=100M --critical-at=20G - size of entries greater than 100M will be colored yellow, and greater than 20G will be colored red - not necessarily useful, just for fun :)
